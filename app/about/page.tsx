      ...
      <section className="relative overflow-hidden">
        <div className="section-padding pt-32 pb-20">
          <AnimatedSection className="mx-auto max-w-3xl text-center">
            <h1
              className="text-4xl font-bold leading-tight text-stone-900 sm:text-5xl lg:text-6xl"
              style={{ fontFamily: "var(--font-display)", letterSpacing: "-0.025em" }}
            >
              About <span className="text-emerald-600">SafeRole</span>
            </h1>
        ...
        <div className="section-padding py-16">
          <div className="mx-auto max-w-5xl">
            <AnimatedSection className="grid gap-8 md:grid-cols-2 md:gap-12">
              <div className="rounded-2xl border border-stone-200 bg-white p-8 shadow-[0_2px_12px_rgba(28,25,23,0.06)]">
        ...
        <div className="section-padding py-16">
          ...
          <AnimatedSection className="mx-auto grid max-w-5xl gap-6 sm:grid-cols-3">
            {[
              ...
              <div key={value.title} className="rounded-2xl border border-stone-200 bg-white p-6 shadow-[0_2px_12px_rgba(28,25,23,0.06)]">
                <h3
        ...
        <div className="section-padding py-16">
          ...
          <AnimatedSection className="mx-auto grid max-w-3xl gap-8 sm:grid-cols-3">
            {TEAM_MEMBERS.map((member, index) => (
              <div
                key={index}
                className="flex flex-col items-center rounded-2xl border border-stone-200 bg-white p-8 text-center shadow-[0_2px_12px_rgba(28,25,23,0.06)]"
              >
                {/* Avatar with initials */}
                <div className="mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-emerald-50 ring-2 ring-emerald-200">
                  <span
