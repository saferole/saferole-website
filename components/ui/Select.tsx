  ...
  return (
    <div className={cn("flex flex-col gap-2", className)}>
      ...
      <select
        ...
        className={cn(
          "w-full appearance-none bg-white border border-stone-200 rounded-xl px-4 py-3 text-stone-900",
          ...
          "bg-[url('data:image/svg+xml;charset=utf-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2216%22%20height%3D%2216%22%20fill%3D%22rgba(168%2C162%2C158%2C1)%22%20viewBox%3D%220%200%2016%2016%22%3E%3Cpath%20d%3D%22M4%206l4%204%204-4%22%20stroke%3D%22rgba(168%2C162%2C158%2C1)%22%20stroke-width%3D%222%22%20fill%3D%22none%22%2F%3E%3C%2Fsvg%3E')] bg-[length:16px] bg-[position:right_12px_center] bg-no-repeat pr-10"
        )}
      >
        {placeholder && (
